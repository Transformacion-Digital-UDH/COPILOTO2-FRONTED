...
/**
 * Tabla para emitir resolución de aprobación de Plan de tesis
 * Sigue el mismo patrón que EmitirResolucionTable y EmitirResolucionJuradoTable
 */
const EmitirResolucionAprobacionTable = ({ 
  data = [],
  onAction,
  loading = false,
  busqueda, 
  ...
  const columnas = [
    ...
    { nombre: 'Asesores', alineacion: 'text-left' },
    { nombre: 'Jurado objetante', alineacion: 'text-left' },
      ...
      {loading ? (
        <div className="flex justify-center items-center py-8">
          <div className="text-gray-500 dark:text-gray-400">
            Cargando resoluciones de aprobación...
          </div>
        </div>
      ) : (
          ...
          <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
            {data.length === 0 ? (
              <tr>
                ...
                >
                  No se encontraron resoluciones de aprobación para emitir
                </td>
              </tr>
            ) : (
              data.map((resolucion) => (
                ...
                >
                  ...
                  <td className="px-4 py-4 text-sm text-gray-900 dark:text-gray-100">
                    <div className="space-y-1">
                      <div>
                        <span className="font-medium">A.T:</span> {resolucion.asesores.tecnico}
                      </div>
                      <div>
                        <span className="font-medium">A.M:</span> {resolucion.asesores.metodologico}
                      </div>
                    </div>
                  </td>
                  <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100">
                    {resolucion.juradoObjetante}
                  </td>
...
export default EmitirResolucionAprobacionTable;
