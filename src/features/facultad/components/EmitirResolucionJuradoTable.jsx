...
/**
 * Tabla para emitir resolución de designación de jurado objetante
 * Sigue el mismo patrón que EmitirResolucionTable
 */
const EmitirResolucionJuradoTable = ({ 
  data = [],
  onAction,
  loading = false,
  busqueda, 
      ...
      {loading ? (
        <div className="flex justify-center items-center py-8">
          <div className="text-gray-500 dark:text-gray-400">
            Cargando resoluciones de jurado...
          </div>
        </div>
      ) : (
          ...
          <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
            {data.length === 0 ? (
              <tr>
                ...
                >
                  No se encontraron resoluciones de jurado objetante para emitir
                </td>
              </tr>
            ) : (
              data.map((resolucion) => (
...
export default EmitirResolucionJuradoTable;
